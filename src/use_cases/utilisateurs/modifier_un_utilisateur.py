...
class ModifierUnUtilisateur:  
    ...
    async def executer(self, utilisateur_data: UtilisateurUpdateSchema, utilisateur_id: UUID) -> Utilisateur | None: 
        utilisateur_a_modifier = await self.utilisateur_repository.trouver_par_id(utilisateur_id)
        ...
        utilisateur_a_jour = await self.utilisateur_repository.trouver_par_id(utilisateur_id)
